...
def main():
    ...
    agent_2 = AgentQ(window_width, window_height, 0.8, 0.1, 0.2)
    ...
    for i in range(num_episodes):
        ...
        reward1sum, reward2sum, episode_duration = run_learning_episode_Q(agent_1, agent_2)
    ...
    fig1.savefig('grafico_ricompense_learning_q.pdf')
    fig2.savefig('grafico_durate_learning_q.pdf')
