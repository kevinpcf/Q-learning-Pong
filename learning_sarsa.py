...
def main():
    ...
    for i in range(num_episodes):
        ...
        reward1sum, reward2sum, episode_duration = run_learning_episode_sarsa(agent_1, agent_2)
    ...
    fig1.savefig('grafico_ricompense_learning_sarsa.pdf')
    fig2.savefig('grafico_durate_learning_sarsa.pdf')
